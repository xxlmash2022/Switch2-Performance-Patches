...
Dieses Repo enthält nur den Switch‑2‑Scraper. Damit **AzerothCore** und **mod‑playerbots** auf deinem Ubuntu‑Server sauber durchlaufen, nutze die Playerbot‑Branch und die offiziellen Installer‑Schritte:
...
3. Abhängigkeiten installieren (Ubuntu):
   `cd azerothcore-wotlk && sudo ./acore.sh install-deps`
